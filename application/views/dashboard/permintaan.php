                                                ...
                                                <tr>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h5 class="card-title"><?php echo $data->kode_penawaran ?></h5>
                                                                    <p class="card-text"><?php echo $data->instansi_pengguna ?></p>
                                                                    <p class="card-text"><?php echo $data->tgl_penawaran ?></p>
                                                                    <p class="card-text"><?php echo $data->qty_penawaran ?></p>
                                                                    <a href="#" class="btn btn-primary"><?php echo $data->nama_produk ?></a>
                                                                </div>
                                                            </div>
                                                        </div>
