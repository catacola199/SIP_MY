                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="<?= site_url('welcome/steptwo') ?>">Dashboard</a>
                                        <i class="fas fa-angle-double-right"></i> Absensi Pengajar
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Absensi Pengajar</h4>
                                <hr>
                                ...
                                <div class="table-responsive">
                                    <table id="multi_col_order" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($absensi_pengajar as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('welcome/edit_absensipengajar/' . $data->id_absensi) ?>" class="btn btn-sm btn-outline-warning">
                                                            <i class="fas fa-edit" data-toggle="tooltip" data-placement="bottom" title="Edit"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-sm btn-outline-info">
                                                            <i class="fas fa-eye" data-toggle="tooltip" data-placement="bottom" title="Detail"></i>
                                                        </a>

                                                        <!-- <a onclick="deleteConfirm('<?php //echo site_url('welcome/deleteabsensi/' . $data->id) 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="success-header-modalLabel">Form Absensi Pengajar
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <!-- Form -->
                    <form action="<?php echo base_url('welcome/save_absensipengajar') ?>" method="post" enctype="multipart/form-data" role="form" class="pl-3 pr-3">

                        <div class="form-group">
                            <label for="id_pengajar"><strong>NIK/NIP PENGAJAR</strong></label>
                            <select class="form-control text-secondary" name="id_pengajar" required>
                                <option value="">--Pilih Nama--</option>
                                <?php foreach ($pengajar as $data) : ?>
                                    <option value="<?php echo $data->id_pengajar; ?>"> <?php echo $data->nama; ?> (<?php echo $data->nik_nip; ?>) </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="text-secondary" name="note" id="" cols="46" rows="5" placeholder=" contoh : hadir, sakit"></textarea>
                        </div>
