                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="<?= site_url('welcome/steptwo') ?>">Dashboard</a>
                                        <i class="fas fa-angle-double-right"></i> Mapel
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($mapel as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $data->status_mapel ?></td>
                                                    <!-- <td>
                                                    </td> -->
                                                </tr>
                                            <?php endforeach; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="success-header-modalLabel">Form Tambah Mapel Baru
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <!-- Form -->
                    <form action="<?php echo base_url('welcome/save_mapel') ?>" method="post" enctype="multipart/form-data" role="form" class="pl-3 pr-3">

                        <div class="form-group">
                            <label for="nama"><strong>Nama Mapel Baru</strong></label>
                            <input class="form-control" <?php echo form_error('nama_mapel') ? 'is-invalid' : '' ?> type="text" name="nama_mapel" required>
                        ...
                        <div class="form-group">
                            <!-- <label for="nama"><strong>Nama Mapel Baru</strong></label> -->
                            <input class="form-control" type="hidden" value="1" <?php echo form_error('status_mapel') ? 'is-invalid' : '' ?> type="text" name="status_mapel" required>
                            <div class="invalid-feedback">
                                <?php echo form_error('status_mapel') ?>
                            </div>
                        </div>
