                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nip" name="nip" placeholder="123123XXX" required maxlength="16">
                            </div>
                            <div class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="npwp" name="npwp" placeholder="0000XXXXXXXXX" required maxlength="16">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
